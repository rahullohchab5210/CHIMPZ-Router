                    ...
                    <div className="navbar">
                        <div className="flex items-center justify-between w-full ">
                            ...
                            <div className="items-center flex w-full max-lg:flex-row-reverse">
                                ...
                                <label htmlFor="menu-icon" className="justify-between  max-[1024px]:w-[30px] max-[1024px]:h-[25px] max-[1024px]:flex max-[1024px]:flex-col max-[1024px]:justify-between max-[1024px]:cursor-pointer max-[1024px]:z-2 max-[1024px]:relative max-[1024px]:float-right      max-[1024px]:peer-checked:justify-center max-[1024px]:ml-2">
